 ...
 * Tier: OFFICIAL_BASELINE (Verified enumerated civil infrastructure & historical reference)
 * 
...
(function(window) {
  ...
  const REFERENCE_DATA = {
    ...
    hospitals: [
      { id: 'HOSP001', name: 'GGH Kakinada',                             lat: 16.9800, lng: 82.2400, beds: 1500, emergency: true, district: 'Kakinada', sourceId: 'ap_sdma_shelters', tier: 'OFFICIAL_BASELINE' },
      { id: 'HOSP002', name: 'King George Hospital (KGH) Visakhapatnam', lat: 17.7088, lng: 83.3056, beds: 1200, emergency: true, district: 'Visakhapatnam', sourceId: 'ap_sdma_shelters', tier: 'OFFICIAL_BASELINE' },
      { id: 'HOSP003', name: 'GGH Vijayawada',                           lat: 16.5120, lng: 80.6380, beds: 1000, emergency: true, district: 'NTR', sourceId: 'ap_sdma_shelters', tier: 'OFFICIAL_BASELINE' },
      { id: 'HOSP004', name: 'RIMS Ongole',                              lat: 15.5120, lng: 80.0450, beds: 800,  emergency: true, district: 'Prakasam', sourceId: 'ap_sdma_shelters', tier: 'OFFICIAL_BASELINE' },
      { id: 'HOSP005', name: 'SVIMS Tirupati',                           lat: 13.6380, lng: 79.4080, beds: 900,  emergency: true, district: 'Tirupati', sourceId: 'ap_sdma_shelters', tier: 'OFFICIAL_BASELINE' },
      { id: 'HOSP006', name: 'District Hospital Rajahmundry',            lat: 17.0050, lng: 81.7820, beds: 650,  emergency: true, district: 'East Godavari', sourceId: 'ap_sdma_shelters', tier: 'OFFICIAL_BASELINE' }
    ],

    // ---- Historical Events Catalog (Andhra Pradesh Regional Disasters) ----
    historicalEvents: [
      { year: 2023, type: 'Cyclone', name: 'Cyclone Michaung', affected: 350000, state: 'Andhra Pradesh', tier: 'OFFICIAL_BASELINE' },
      { year: 2022, type: 'Flood',   name: 'Godavari Flash Deluge', affected: 420000, state: 'Andhra Pradesh', tier: 'OFFICIAL_BASELINE' },
      { year: 2018, type: 'Cyclone', name: 'Cyclone Titli', affected: 280000, state: 'Andhra Pradesh', tier: 'OFFICIAL_BASELINE' },
      { year: 2014, type: 'Cyclone', name: 'Cyclone Hudhud', affected: 500000, state: 'Andhra Pradesh', tier: 'OFFICIAL_BASELINE' },
      { year: 1990, type: 'Cyclone', name: '1990 AP Super Cyclone', affected: 1000000, state: 'Andhra Pradesh', tier: 'OFFICIAL_BASELINE' }
    ]
  };
